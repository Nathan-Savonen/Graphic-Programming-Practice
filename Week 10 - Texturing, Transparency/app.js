...
function updateAndRender() {
    ...
    const painterAlgorithm = sphereGeometryList.sort(function(worldMatrix,cameraWorldMatrix) {
        const front = worldMatrix.getPosition() - cameraWorldMatrix.getPosition();
        const back = cameraWorldMatrix.getPosition() - worldMatrix.getPosition();
