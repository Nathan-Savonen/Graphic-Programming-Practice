...
Matrix4.prototype = {
	...
	multiplyVector: function(v) {
		...
		result.x = te[0] * v.x + te[1] * v.y + te[2] * v.z + te[3] * v.w;
		result.y = te[4] * v.x + te[5] * v.y + te[6] * v.z + te[7] * v.w;
		result.z = te[8] * v.x + te[9] * v.y + te[10] * v.z + te[11] * v.w;
		result.w = te[12] * v.x + te[13] * v.y + te[14] * v.z + te[15] * v.w;
	...
	createMoonMatrix: function(moonRotationAngle, offsetFromEarth, earthWorldMatrix) {
		...
		moonMatrix = earthWorldMatrix.multiply(moonMatrix).multiply(newmoonMatrix);
