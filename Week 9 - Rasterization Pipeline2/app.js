...
function createScene() {
    ...
    sphereGeometry.worldMatrix.multiply(new Matrix4().clone().makeTranslation(0,0,-5));
    sphereGeometry.worldMatrix.multiply(new Matrix4().clone().makeScale(0.01,0.01,0.01));
