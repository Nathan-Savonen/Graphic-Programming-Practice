...
function updateAndRender() {
    ...
    var lightPosition = new Vector4(5, 3, 0,0);
    var yaw = new Matrix4().makeRotationY(45);
    var pitch = new Matrix4().makeRotationX(315);

    if(appInput.right){
        lightPosition = yaw.multiplyVector(lightPosition);
    }
    if(appInput.left){
        lightPosition = yaw.multiplyVector(lightPosition);
    ...
    if(appInput.up){
        lightPosition = pitch.multiplyVector(lightPosition);
